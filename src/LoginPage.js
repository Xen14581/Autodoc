    ...
    <>
        ...
        <div className="login__box">
          ...
          <div className="login__textbox">
            ...
            <button onClick={()=> {history.push('/home')}}>Patient Login</button>
            <button onClick={()=> history.push('/dochome')}>Doc Login</button>
            <button onClick={()=> history.push('/adminhome')}>Admin Login</button>
        </div>
